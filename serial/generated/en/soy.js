...
Serial.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Serial.soy.messages(null, null, opt_ijData) + '<div class="header"><a id="back" href="index.html" class="logo"><img id="banner" src="static/img/index/blocklypar0.png" width="70" alt="Blockly Games"></a>&nbsp<td><a><h1>' + BlocklyGames.soy.titleSpan({appName: 'Sequential Programming'}, null, opt_ijData) + '<center>' + BlocklyGames.soy.levelLinks({level: opt_ijData.level, maxLevel: opt_ijData.maxLevel, lang: opt_ijData.lang, suffix: '&skin=' + soy.$$escapeHtml(opt_ijData.skin)}, null, opt_ijData) + '</center></h1></a></td><div class="nav-spacer"></div></div>&nbsp<div id="visualization"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="400px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg></div><table width="400"><tr><div class=\'parent\'><div align=\'left\' class=\'child inline-block-child\' id="counter"></div><div align=\'center\' class=\'child inline-block-child\' id="number"></div><div align=\'center\' class=\'child inline-block-child\' id="timeBubble"> <div id="time"></div> </div><div align=\'right\' class=\'child inline-block-child\' id="capacityBubble"> <div id="capacity"></div> </div></div><td style="width: 220px; text-align: right; vertical-align: top;"><td><button id="runButton" class="primary" title="Makes the player do what the blocks say."><img src="common/1x1.gif" class="run icon21"> Run Program</button><button id="resetButton" class="primary" style="display: none" title="Put the player back at the start of the maze."><img src="common/1x1.gif" class="stop icon21"> Reset</button></td></tr></table>' + Serial.soy.toolbox(null, null, opt_ijData) + '<div id="blockly"></div><div id="pegmanMenu"></div>' + BlocklyGames.soy.dialog(null, null, opt_ijData) + BlocklyGames.soy.doneDialog(null, null, opt_ijData) + BlocklyGames.soy.abortDialog(null, null, opt_ijData) + BlocklyGames.soy.storageDialog(null, null, opt_ijData) + ((opt_ijData.level == 1) ? '<div id="dialog1Intro" class="dialogHiddenContent"><div style="font-size: large; margin: 1em;"><center><h3>LEVEL 1</center></h3></div><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0; text-align: center;">Programming with blocks is easy!<table cellspacing="5"><tr><td><img class="img-responsive" src="static/img/games/serial/level1.png"></td><td>Just drag and drop the blocks together, one above the other to build your program.</td></table><button id="playStart" class="secondary">Ok</button></div></div><div id="dialogHelpOneTopBlock" class="dialogHiddenContent"><table><tr><td>You need to stack together all the blocks that you want to use.</td><td><div id="sampleOneTopBlock" class="readonly"></div></td></tr></table></div><div id="dialogHelpRun" class="dialogHiddenContent"><table><tr><td><img src="static/img/games/serial/left.png"></td><td>Run your program by clicking here!</td></tr></table></div>' : (opt_ijData.level == 2) ? '<div id="dialogHelpReset" class="dialogHiddenContent"><table><tr><td colspan="2">Your program didn\'t solve this level.</td></tr><tr><td><img src="static/img/games/serial/left.png"></td><td>Click \'Reset\' and try again.</td></tr></table></div>' : (opt_ijData.level == 3) ? '<div id="dialogHelpIfElse" class="dialogHiddenContent">An \'if-else\' block will do one thing if the condition is true or the other, if the condition is false.</div>' : '');
};
if (goog.DEBUG) {
