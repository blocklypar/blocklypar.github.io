...
Index.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="title">Jogos do Blockly</span><span id="Index_clear">Deletar todas as suas solu\u00E7\u00F5es?</span></div>';
};
if (goog.DEBUG) {
