...
BlocklyGames.soy.levelLinks = function(opt_data, opt_ignored, opt_ijData) {
  var output = ' &nbsp; ';
  var iLimit138 = opt_data.maxLevel + 1;
  for (var i138 = 1; i138 < iLimit138; i138++) {
    output += ' ' + ((i138 == opt_data.level) ? '<a class="level_number level_done" id="level' + soy.$$escapeHtml(i138) + '">' + soy.$$escapeHtml(i138) + '</a>' : (i138 == opt_data.maxLevel) ? '<a class="level_number" id="level' + soy.$$escapeHtml(i138) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i138) + soy.$$escapeHtml(opt_data.suffix) + '">' + soy.$$escapeHtml(i138) + '</a>' : '<a class="level_dot" id="level' + soy.$$escapeHtml(i138) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i138) + soy.$$escapeHtml(opt_data.suffix) + '"></a>');
  }
  return output;
};
if (goog.DEBUG) {
...
BlocklyGames.soy.doneDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogDone" class="dialogHiddenContent"><div style="font-size: large; margin: 1em;">Congratulations!</div><div id="dialogDonePerformance" style="font-size: large; margin: 1em; font-weight:bold;">You resolve the challenge in:</div><div id="dialogLinesText" style="font-size: large; margin: 1em;"></div><pre id="containerCode"></pre><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="doneCancel">Cancel</button><button id="doneOk" class="secondary">OK</button></div></div>';
};
if (goog.DEBUG) {
