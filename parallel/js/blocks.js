 ...
 */
Parallel.Blocks.MOVEMENT_HUE = 290;

/**
 * HSV hue for loop block.
 */
Parallel.Blocks.LOOPS_HUE = 120;

/**
 * Common HSV hue for all logic blocks.
 */
Parallel.Blocks.LOGIC_HUE = 210;

/**
 * Common HSV hue for student dropbox.
 */
Parallel.Blocks.STUDENT_HUE = 45;

/**
 * Common HSV hue for task block.
 */
Parallel.Blocks.TASK_HUE = 182;

/**
 * Common HSV hue for tasks in parallel.
 */
Parallel.Blocks.TASK_PAR = 90;


/**
 * Left turn arrow to be appended to messages.
 */
Parallel.Blocks.LEFT_TURN = ' \u21BA';

/**
 * Left turn arrow to be appended to messages.
 */
Parallel.Blocks.RIGHT_TURN = ' \u21BB';
...
Blockly.Blocks['maze_moveForward'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "nextStatement": null,
      "colour": Parallel.Blocks.MOVEMENT_HUE,
...
Blockly.Blocks['maze_turn'] = {
  ...
  init: function() {
    ...
    DIRECTIONS[0][0] += Parallel.Blocks.LEFT_TURN;
    DIRECTIONS[1][0] += Parallel.Blocks.RIGHT_TURN;
    this.setColour(Parallel.Blocks.MOVEMENT_HUE);
...
Blockly.Blocks['maze_if'] = {
  ...
  init: function() {
    ...
    // Append arrows to direction messages.
    DIRECTIONS[1][0] += Parallel.Blocks.LEFT_TURN;
    DIRECTIONS[2][0] += Parallel.Blocks.RIGHT_TURN;
    this.setColour(Parallel.Blocks.LOGIC_HUE);
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown(DIRECTIONS), 'DIR');
...
Blockly.Blocks['maze_forever'] = {
   ...
   */
  init: function() {
    this.setColour(Parallel.Blocks.LOOPS_HUE);
    this.appendDummyInput()
        .appendField(BlocklyGames.getMsg('Maze_repeatUntil'))
        .appendField(new Blockly.FieldImage(Parallel.Level3.VIEW.finishMarker, 12, 16));
    this.appendStatementInput('DO')
        .appendField(BlocklyGames.getMsg('Maze_doCode'));
    this.setPreviousStatement(true);
...
Blockly.Blocks['maze_forever_books'] = {
   ...
   */
  init: function() {
    this.setColour(Parallel.Blocks.TASK_HUE);
    this.appendDummyInput()
        .appendField(BlocklyGames.getMsg('Maze_repeatTaskUntil'))
        .appendField(new Blockly.FieldImage(Parallel.Level3.VIEW.book, 20, 17))
...
Blockly.JavaScript['maze_forever_books'] = function(block) {
...
/**
 * Books equal zero parallel
 */
Blockly.Blocks['maze_forever_booksPar'] = {
  /**
   * Block for repeat loop.
   * @this Blockly.Block
   */
  init: function() {
    this.setColour(Parallel.Blocks.TASK_PAR);
    this.appendDummyInput()
        .appendField(BlocklyGames.getMsg('Maze_repeatTaskUntil'))
        .appendField(new Blockly.FieldImage(Parallel.Level3.VIEW.book, 20, 17))
        .appendField(BlocklyGames.getMsg('Maze_booksZeroPar'));
    this.appendStatementInput('DO')
        .appendField(BlocklyGames.getMsg('Maze_doCode'));
    this.setPreviousStatement(true);
    this.setTooltip(BlocklyGames.getMsg('Maze_whileBooksTooltipPar'));
  }
};

Blockly.JavaScript['maze_forever_booksPar'] = function(block) {
...
Blockly.Blocks['maze_1student'] = {
  ...
  init: function() {
    ...
    this.setColour(Parallel.Blocks.STUDENT_HUE);
    this.appendDummyInput()
