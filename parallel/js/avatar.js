...
goog.provide('Parallel.Avatar');


Parallel.Avatar = function(id, startDirection, startLocX, startLocY, sprite){
    this.id = id;
...
Parallel.Avatar.prototype.reset = function(startDirection, startLocX, startLocY) {
