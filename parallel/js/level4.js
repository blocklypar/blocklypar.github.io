...
Parallel.Level4.Animate = function(){
    ...
    if(action3){
        Parallel.currentStudent = student[2];
...
Parallel.Level4.InitInterpreter = function(interpreter, scope){
    ...
    wrapper = function(id) {
        Parallel.Level4.move(0, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'moveForward',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        Parallel.Level4.move(2, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'moveBackward',
        interpreter.createNativeFunction(wrapper));
        
    wrapper = function(id) {
        Parallel.Level4.turn(0, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'turnLeft',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        Parallel.Level4.turn(1, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'turnRight',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
    return Parallel.Level4.isPath(0, id, Parallel.currentStudent);
    };
    ...
    wrapper = function(id) {
        return Parallel.Level4.isPath(1, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'isPathRight',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        return Parallel.Level4.isPath(2, id, Parallel.currentStudent);
    };
    interpreter.setProperty(scope, 'isPathBackward',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        return Parallel.Level4.isPath(3, id, Parallel.currentStudent);
    };
    ...
    //Books == 0
    wrapper = function() {
        return Parallel.Level4.ReturnBook(Parallel.currentStudent.startLoc.x, Parallel.currentStudent.startLoc.y);
    };
...
Parallel.Level4.ScheduleFinish = function(sound) {
    ...
    Parallel.Level4.DisplayStudent(Parallel.currentStudent.startLoc.x, Parallel.currentStudent.startLoc.y, 16);
    if (sound) {
      BlocklyGames.workspace.getAudioManager().play('win', 0.5);
    }
    pidList.push(setTimeout(function() {
        Parallel.Level4.DisplayStudent(Parallel.currentStudent.startLoc.x, Parallel.currentStudent.startLoc.y, 18);
      }, Parallel.stepSpeed));
    pidList.push(setTimeout(function() {
        Parallel.Level4.DisplayStudent(Parallel.currentStudent.startLoc.x, Parallel.currentStudent.startLoc.y, 16);
      }, Parallel.stepSpeed * 2));
    pidList.push(setTimeout(function() {
        Parallel.Level4.DisplayStudent(Parallel.currentStudent.startLoc.x, Parallel.currentStudent.startLoc.y, direction16);
      }, Parallel.stepSpeed * 3));
  };
