...
goog.provide('Tasks.Avatar');


Tasks.Avatar = function(id, startDirection, startLocX, startLocY, sprite){
    this.id = id;
...
Tasks.Avatar.prototype.reset = function(startDirection, startLocX, startLocY) {
