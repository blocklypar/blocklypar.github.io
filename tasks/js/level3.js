 ...
 */
Tasks.Level3.DrawMap = function(svg){

    //Create cenario:
    if (Tasks.Level3.VIEW.background) {
        var tile = document.createElementNS(Blockly.utils.dom.SVG_NS, 'image');
        tile.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.background);
    ...
    if (Tasks.Level3.VIEW.graph) {
        ...
        for (var k = 0; k < Tasks.ROWS; k++) {
          ...
          h_line.setAttribute('stroke', Tasks.Level3.VIEW.graph);
        ...
        for (var k = 0; k < Tasks.COLS; k++) {
          ...
          v_line.setAttribute('stroke', Tasks.Level3.VIEW.graph);
    ...
    for (var y = 0; y < Tasks.ROWS; y++) {
        for (var x = 0; x < Tasks.COLS; x++) {
            ...
            // Tile sprite.
            var tile = document.createElementNS(Blockly.utils.dom.SVG_NS, 'image');
            tile.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.tiles);
 ...
 */
Tasks.Level3.AddSprites = function(svg, document){

    // Create finish markers.
    var finishMarkers = document.createElementNS(Blockly.utils.dom.SVG_NS, 'image');
    finishMarkers.id = 'finish';
    finishMarkers.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.finishMarker);
    ...
    pegmanIcon.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.skin);
...
Tasks.Level3.AddActivitySprites = function(){
    ...
    activity1.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.activity);
    activity1.setAttribute('height', 45);
    activity1.setAttribute('width', 35);

    svg.appendChild(activity1);
    activity1.setAttribute('x', Tasks.SQUARE_SIZE * (Tasks.Level3.activity_.pos0.x + 0.5) -
    activity1.getAttribute('width') / 2);
    activity1.setAttribute('y', Tasks.SQUARE_SIZE * (Tasks.Level3.activity_.pos0.y + 0.6) - activity1.getAttribute('height'));


    var activity2 = document.createElementNS(Blockly.utils.dom.SVG_NS, 'image');
    activity2.id = 'activity1';
    activity2.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.activity);
    activity2.setAttribute('height', 45);
    activity2.setAttribute('width', 35);
    svg.appendChild(activity2);
    activity2.setAttribute('x', Tasks.SQUARE_SIZE * (Tasks.Level3.activity_.pos1.x + 0.5) -
    activity2.getAttribute('width') / 2);
    activity2.setAttribute('y', Tasks.SQUARE_SIZE * (Tasks.Level3.activity_.pos1.y + 0.6) - activity2.getAttribute('height'));
 ...
 */
Tasks.Level3.ActivityDone = function(){
    ...
    activity.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', Tasks.Level3.VIEW.activity);
    ...
    Tasks.Level3.activity_.pos = Tasks.Level3.activity_.pos + 1;
    activity.setAttribute('y', Tasks.SQUARE_SIZE * (Tasks.Level3.activity_.pos + 2.5) - activity.getAttribute('height'));

    //Remove activity from the maze
    var name = 'activity';
    var svg = document.getElementById('svgMaze');
    if(Tasks.Level3.activity_.num == 2)
        activity = document.getElementById(name.concat('0'));
    else if(Tasks.Level3.activity_.num == 3)
        activity = document.getElementById(name.concat('1'));
    else
        activity = document.getElementById(name.concat(Tasks.Level3.activity_.num.toString()));
 ...
 */
Tasks.Level3.Reset = function(first){
    ...
    if (first) {
        ...
        pidList.push(setTimeout(function() {
            Tasks.Level3.Schedule([student.startLoc.x, student.startLoc.y, student.startDirection * 4],
                        [student.startLoc.x, student.startLoc.y, student.startDirection * 4 - 4]);
                        student.startDirection++;
        }, Tasks.stepSpeed * 4));
    } else {
        Tasks.Level3.DisplayStudent(student.startLoc.x, student.startLoc.y, Tasks.startDirection * 4);
    }
...
Tasks.Level3.Execute = function(){
    ...
    var interpreter = new Interpreter(code, Tasks.Level3.InitInterpreter);
    ...
    try {
        ...
        Tasks.result = Tasks.Level3.NotDone() ?
    ...
    Tasks.Level3.Reset(false);
    pidList.push(setTimeout(Tasks.Level3.Animate, 150));
};


Tasks.Level3.Animate = function(){
    ...
    switch (action[0]) {
        ...
        case 'look_north':
        Tasks.Level3.ScheduleLook(Tasks.DirectionType.NORTH, student.startLoc.x, student.startLoc.y);
        break;

        case 'look_east':
        Tasks.Level3.ScheduleLook(Tasks.DirectionType.EAST, student.startLoc.x, student.startLoc.y);
        break;
        
        case 'look_south':
        Tasks.Level3.ScheduleLook(Tasks.DirectionType.SOUTH, student.startLoc.x, student.startLoc.y);
        break;
        
        case 'look_west':
        Tasks.Level3.ScheduleLook(Tasks.DirectionType.WEST, student.startLoc.x, student.startLoc.y);
        break;
        
        case 'fail_forward':
        Tasks.Level3.ScheduleFail(true);
        break;
        
        case 'fail_backward':
        Tasks.Level3.ScheduleFail(false);
        break;
    ...
    pidList.push(setTimeout(Tasks.Level3.Animate, Tasks.stepSpeed * 4));
}
 ...
 */
Tasks.Level3.InitInterpreter = function(interpreter, scope){

    // API
    var wrapper;

    wrapper = function(id) {
        Tasks.Level3.move(0, id);
    };
    interpreter.setProperty(scope, 'moveForward',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        Tasks.Level3.move(2, id);
    };
    interpreter.setProperty(scope, 'moveBackward',
        interpreter.createNativeFunction(wrapper));
        
    wrapper = function(id) {
        Tasks.Level3.turn(0, id);
    };
    interpreter.setProperty(scope, 'turnLeft',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        Tasks.Level3.turn(1, id);
    };
    interpreter.setProperty(scope, 'turnRight',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
    return Tasks.Level3.isPath(0, id);
    };
    interpreter.setProperty(scope, 'isPathForward',
    interpreter.createNativeFunction(wrapper));
   
    wrapper = function(id) {
        return Tasks.Level3.isPath(1, id);
    };
    interpreter.setProperty(scope, 'isPathRight',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        return Tasks.Level3.isPath(2, id);
    };
    interpreter.setProperty(scope, 'isPathBackward',
        interpreter.createNativeFunction(wrapper));

    wrapper = function(id) {
        return Tasks.Level3.isPath(3, id);
    };
    interpreter.setProperty(scope, 'isPathLeft',
        interpreter.createNativeFunction(wrapper));

    wrapper = function() {
        return Tasks.Level3.NotDone();
    };
    ...
    wrapper = function() {
        ...
        // return Tasks.Level3.GetActivity(student.startLoc.x, student.startLoc.y);
    };
 ...
 */
Tasks.Level3.move = function(direction, id) {

    if (!Tasks.Level3.isPath(direction, null)) {
 ...
 * @param {string} id ID of block that triggered this action.
 */
Tasks.Level3.turn = function(direction, id) {
 ...
 */
Tasks.Level3.isPath = function(direction, id) {
 ...
 */
Tasks.Level3.Schedule = function(startPos, endPos) {

    var deltas = [(endPos[0] - startPos[0])/4, (endPos[1] - startPos[1])/4, (endPos[2] - startPos[2])/4];

    pidList.push(setTimeout(function() {
    Tasks.Level3.DisplayStudent(startPos[0] + deltas[0],
        startPos[1] + deltas[1],
        Tasks.constrainDirection16(startPos[2] + deltas[2]));
    }, Tasks.stepSpeed));

    pidList.push(setTimeout(function() {
        Tasks.Level3.DisplayStudent(startPos[0] + deltas[0] * 2,
            startPos[1] + deltas[1] * 2,
            Tasks.constrainDirection16(startPos[2] + deltas[2] * 2));
    }, Tasks.stepSpeed));

    pidList.push(setTimeout(function() {
    Tasks.Level3.DisplayStudent(startPos[0] + deltas[0] * 3,
        startPos[1] + deltas[1] * 3,
        Tasks.constrainDirection16(startPos[2] + deltas[2] * 3));
    }, Tasks.stepSpeed * 2));

    pidList.push(setTimeout(function() {
        Tasks.Level3.DisplayStudent(endPos[0], endPos[1],
 ...
 */
Tasks.Level3.ScheduleFail = function(forward) {
    ...
    Tasks.Level3.DisplayStudent(student.startLoc.x, student.startLoc.y + deltaY,
                        direction16);

    BlocklyGames.workspace.getAudioManager().play('fail', 0.5);
    pidList.push(setTimeout(function() {
        Tasks.Level3.DisplayStudent(student.startLoc.x, student.startLoc.y,
                            direction16);
    }, Tasks.stepSpeed));

    pidList.push(setTimeout(function() {
        Tasks.Level3.DisplayStudent(student.startLoc.x + deltaX,
    ...
    pidList.push(setTimeout(function() {
        Tasks.Level3.DisplayStudent(student.startLoc.x, student.startLoc.y, direction16);
    }, Tasks.stepSpeed * 3));
};
 ...
 */
Tasks.Level3.DisplayStudent = function(x, y, d, opt_angle) {
    ...
    if(Tasks.Level3.isActivity(x, y)){
        Tasks.Level3.ActivityDone();
        Tasks.Level3.activity_.num++;
    }
 ...
 */
Tasks.Level3.ScheduleLook = function(d, x, y) {
...
Tasks.Level3.NotDone = function(){
    return Tasks.Level3.activity_.num != 2;
};
...
Tasks.Level3.RemoveActivities = function(){

    var svg = document.getElementById('svgMaze');
    var actremove;

    for(var i=0 ; i<Tasks.Level3.activity_.num; i++){
    ...
    Tasks.Level3.activity_.num = 0;
    Tasks.Level3.activity_.pos = 0;
};